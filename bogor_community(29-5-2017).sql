...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2017 at 09:02 AM
...
INSERT INTO `posts` (`id_post`, `content`, `date_create_post`, `active`, `id_user`, `id_thread`, `id_community`) VALUES
(2, ' aaaaaaaaaaaaa', '2017-05-27 18:59:57', 1, 48, 0, 0),
(3, 'adkjsakdaslkdasd', '2017-05-27 19:11:13', 1, 48, 0, 0),
(4, 'henlo my fren', '2017-05-27 19:12:27', 1, 48, 0, 0),
(5, 'haiaihaihaiha', '2017-05-27 19:26:40', 1, 48, 0, 0),
(6, 'DJKSANDKSJADNKA', '2017-05-27 19:52:19', 1, 48, 0, 0),
(7, 'huuuuuuuuuuueeeeeee', '2017-05-27 19:56:30', 1, 48, 0, 0),
(8, 'i wanna sleep', '2017-05-27 19:59:09', 1, 48, 0, 0),
(9, 'jlakjslajskasd', '2017-05-27 21:05:32', 1, 48, 0, 0),
(10, 'ndlasndladld', '2017-05-27 21:06:25', 1, 48, 0, 0),
(11, 'dasdnsansakd', '2017-05-27 21:07:35', 1, 48, 0, 0);
...
--
-- Indexes for table `members_community`
--
ALTER TABLE `members_community`
...
ALTER TABLE `posts`
  ...
  ADD KEY `posts_ibfk_3` (`id_community`);
...
--
ALTER TABLE `agendas`
  ADD CONSTRAINT `agendas_ibfk_1` FOREIGN KEY (`id_community`) REFERENCES `communities` (`id_community`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `members_community`
--
ALTER TABLE `members_community`
  ADD CONSTRAINT `members_community_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `members_community_ibfk_2` FOREIGN KEY (`id_community`) REFERENCES `communities` (`id_community`);

--
-- Constraints for table `posts`
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`id_thread`) REFERENCES `threads` (`id_thread`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `threads` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `posts_ibfk_3` FOREIGN KEY (`id_community`) REFERENCES `threads` (`id_community`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `threads`
--
ALTER TABLE `threads`
  ADD CONSTRAINT `threads_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `members_community` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `threads_ibfk_2` FOREIGN KEY (`id_community`) REFERENCES `members_community` (`id_community`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
