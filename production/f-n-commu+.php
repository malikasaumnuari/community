...
<fieldset>
    ...
    <form action="php_action/create.php" method="post">
        <table cellspacing="0" cellpadding="0">
            ...
            <tr>
                <th>Date Create</th>
                <td><input type="date" name="date_create" placeholder="date reate" /></td>
            </tr>
            <tr>
                <th>Category</th>
            ...
            <tr>
                ...
                <td><input type="text" name="address_community" placeholder="address community" /></td>
            </tr>
            <tr>
                <th>About</th>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name_community">Nama Komunitas<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" required="required" col-md-7 col-xs-12">
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" required="required"  col-md-7 col-xs-12>
                            <option>Choose option</option>
                            <option>Sports</option>
                            <option<span class="required"></span>>Arts</option>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Alasan membuat<span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <textarea class="resizable_textarea form-control col-md-7 col-xs-12" required="required"col-md-7 col-xs-12></textarea>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-danger" type="button"><a href="index.html" style="color: white">Cancel</button>
              <button class="btn btn-warning" type="reset">Reset</button>
                          <button type="submit" class="btn btn-success"><a href="admins/create.php" style="color: white">Submit</a></button>
                        </div>
                      </div>
