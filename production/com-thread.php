...
<h3 align='center'><?php echo $data['name_community']?></h3>
              ...
              <ul class='list-unstyled'>
                ...
                <li>
                  <a type="button" class="btn btn-default active col-md-12 col-sm-12 col-xs-12">View Thread</a>
                </li>
              </ul>
            </div>
        </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    $sql3 = mysqli_query($con, "SELECT * FROM communities WHERE active=2 AND id_master = {$id_user} AND id_community={$id_community}");
                      if($sql3->num_rows > 0){ echo '<ul class="nav navbar-right panel_toolbox">
                          <li><a href="thread-edit.php?id_community='.$id_community.'"><i class="fa fa-edit"></i>Edit Thread</a>
                          </li>
                        </ul>';
                      }
                  ...
                  <button type="button" class="btn btn-round btn-success" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle"></i> Create New Thread </button>
                  <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="new-message">New Thread</h4>
                        </div>
                        <div class="modal-body">

                          <form action="threads/php_action/create.php?id_community=<?php echo $id_community?>" method="post" data-parsley-validate class="form-horizontal form-label-right">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title_thread">Judul Thread<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title_thread" name="title_thread" class="form-control" required="required" col-md-7 col-xs-12" >
                        </div>
                      </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <?php
            $sql = "SELECT * FROM threads t, users u WHERE t.active = 1 AND t.id_user=u.id_user AND t.id_community=$id_community ORDER BY t.id_thread";
            $result = $connect->query($sql);

            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        <td><a href='thread-posts.php?id_community=$id_community&amp;id_thread=".$row['id_thread']."'>".$row['title_thread']."</a></td>
                        <td>".$row['username']."</td>
