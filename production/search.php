                    ...
                    <div class="row">
                      ...
                      <?php
                            ...
                            echo "Failed to connect to MySQL: " . mysqli_connect_error();
                              ...
                              {
                                $sql = mysqli_query($con,"SELECT * FROM communities C JOIN users U WHERE U.id_user=C.id_master AND active = 2 AND name_community like '%$cari%' LIMIT $posisi, $batas");
                              }
                            ...
                            <div class='col-md-4 col-sm-4 col-xs-12 profile_details'>
                              <div class='well profile_view'>
                                <div class='col-sm-12'>
                                  <div class='left col-xs-7'>
                                    ...
                                    <ul class='list-unstyled'>
                                      <li> Admin: <a href='profile.html'>".$row['name']."</a></li>
                                ...
                                <div class='col-xs-12 bottom text-center'>
                                   <a type='button' class='btn btn-info btn-xs' href='com-no.php?id_community=".$row['id_community']." '>
                                    View Community </a>
