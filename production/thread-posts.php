...
if($_GET['id_community']) {
    ...
    $sql1 = "SELECT * FROM threads WHERE id_community={$id_community} AND id_thread={$id_thread} AND active=1";
          ...
          <div class="">
            ...
            <h3 align='center'><?php echo $data['name_community']?></h3>
              ...
              <ul class='list-unstyled'>
                ...
                <li>
                  <a href='com-memb.php?id_community=<?php echo $id_community?>' type="button" class="btn btn-default col-md-12 col-sm-12 col-xs-12" >View Members</a>
                </li>
                <li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="x_title">
                    <h2><?php echo $data2['title_thread'];?></h2>
<?php
                      $con=mysqli_connect("127.0.0.1","root","","bogor_community");
                    ...
                    $sql3 = mysqli_query($con, "SELECT * FROM communities WHERE active=2 AND id_master = {$id_user} AND id_community={$id_community}");
                      if($sql3->num_rows > 0){ echo '<ul class="nav navbar-right panel_toolbox">
                          <li><a href="thread-posts-edit.php?id_community='.$id_community.'&amp;id_thread='.$id_thread.'"><i class="fa fa-edit"></i>Edit Posts</a>
                          </li>
                        </ul>';
                      }
                  ...
                  <button type="button" class="btn btn-round btn-success" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle"></i> Post Message</button>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="new-message">Post Message</h4>
                        </div>
                        <div class="modal-body">

                          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-right" action="comments/php_action/create.php?id_thread=<?php echo $id_thread?>&amp;id_community=<?php echo $id_community?>" method="post">

                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="thr-mess">Message<span class="required">*</span></label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="resizable_textarea form-control col-md-12 col-sm-12 col-xs-12" for="thr-mess" required="required" col-md-12 col-sm-12 col-xs-12 name="content"></textarea>
                          </div>
                        </div>
                        <div class="ln_solid"></div>
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                              <button class="btn btn-danger" type="button" data-dismiss="modal">Cancel</a>
                  ...
                  <div class="clearfix"></div>
                     <table id="datatable" class="table table-hover table-striped table-unbordered">
                      <?php
            $sql = "SELECT * FROM posts p, users u WHERE p.id_thread=$id_thread AND p.id_user=u.id_user ORDER BY p.date_create_post";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<thead>
                        <tr>
                          <th>".$row['username']."</th>
                          <th><div align='right'>".$row['date_create_post']."</div></th>
