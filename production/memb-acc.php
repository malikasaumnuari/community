                ...
                <div class="x_panel">
                  ...
                  <div class="table-responsive">
                     <table id="datatable" class="table table-striped table-bordered">
                       ...
                       <tbody>
            <?php
            $sql = "SELECT * FROM members_community m, users u WHERE m.active = 1 AND m.id_member=u.id_user AND m.id_community=$id_community ORDER BY m.date_join";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>".$row['username']."</td>
                        <td>".$row['date_join']."</td>
                        <td>".$row['join_reason']."</td>
                          <td><a href='members/php_action/accept.php?id_member=".$row['id_member']."&amp;id_community=$id_community'><button type='button' class='btn btn-warning'>Accept</button></a></td>
                          <td><a href='members/php_action/remove.php?id_member=".$row['id_member']."&amp;id_community=$id_community'><button type='button' class='btn btn-danger'>Reject</button></a></td>
                          ";
                        }
                        echo "
                        </tr>";
