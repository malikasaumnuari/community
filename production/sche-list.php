            ...
            <h3 align='center'><?php echo $data['name_community']?></h3>
              ...
              <ul class='list-unstyled'>
                  ...
                  <div class="x_content">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="sche-add.php?id_community=<?php echo $id_community?>">Add Schedule</a>
                          </li>
                          <li><a href="sche-list.php?id_community=<?php echo $id_community?>">List Schedule</a>
                          </li>
                        </ul>
                      </li>
                ...
                <th colspan="2">Option</th>
                         ...
                         <tbody>
                              <?php
            $sql = "SELECT * FROM agendas WHERE (active=1 OR active =3 OR active=4) AND id_community={$id_community}";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        ";if($row['active']==1){echo "<td>
                          <a href='agendas/php_action/open.php?id_agenda=".$row['id_agenda']."&amp;id_community=$id_community'><button type 'button' class='btn btn-success'>Start Now</button></a>";}
                          else if ($row['active']==3){echo "<td>
                          <a href='sche-notes.php?id_agenda=".$row['id_agenda']."&amp;id_community=$id_community'><button type 'button' class='btn btn-warning'>End Now</button></a>";}
                          echo "
                        <td colspan=2>
                          <a href='agendas/php_action/remove.php?id_agenda=".$row['id_agenda']."&amp;id_community=$id_community'><button type='button' class='btn btn-danger'>x Remove</button></a>
