...
if($_GET['id_community']) {
    ...
    $sql2 = "SELECT count(1) AS amIyou FROM members_community  WHERE id_member = {$id_user}";
    $sql3 = "SELECT count(1) AS amImaster FROM communities  WHERE id_master = {$id_user}";

if($sql3['amImaster']|| $sql2['amIyou']){
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="agendas/php_action/create.php?id_community=<?php echo $id_community;?>" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="agenda">Event Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="agenda" name="name_agenda" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="datefield" >Date <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="date" id="datefield" name="date_agenda" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="time-started">Time Started <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="time" id="time-started" max='time-ended' name="time_start" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="time-ended">Time Ended <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="time" id="time-ended" min="time-started" name="time_end" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="location" name="agenda_location" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="message" required="required" name="content_agenda" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
...
else header("location: com-sche.php?id_community=$id_community");
}
else echo "error";
}
?>