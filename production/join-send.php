        ...
        <div class="right_col" role="main">
          ...
          <div class="col-middle">
            <div class="text-center text-center">
              ...
              <h2>Success!</h2>
              <p>Registration form has been sent. Please wait for the Community Master's Confirmation.
              </p>
              <div class="mid_center">
                  <button class="btn btn-primary" type="button"><a href="index.php" style="color: white">Back</button>
