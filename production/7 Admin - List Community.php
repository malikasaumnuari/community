      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <!-- Thread -->
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List Communities Accepted</h2>
                ...
                <th>action
                      ...
                      <tbody>
                                    <?php
            $sql = "SELECT * FROM communities where active=2";
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>
                            <a href='communities/remove.php?id_community=".$row['id_community']."'><button type='button'>Remove</button></a>
                        </td>
                    </tr>";
                }
            } else {
