...
<!--content-->
                ...
                <form action="login_user/changepassword.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      &nbsp;
                      <ul class="list-unstyled user_data">
                              <li>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                      <input type="password" name="password" id="name" class="form-control col-md-7 col-xs-12">
                                    </div>
                                  </div>
                              ...
                              <li>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                      <input type="password" name="newpassword" id="name" class="form-control col-md-7 col-xs-12">
                                    </div>
                                  </div>
                              ...
                              <li>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><h4>Confirm Password</h4>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                      <input type="password" name="conformpassword" id="name" class="form-control col-md-7 col-xs-12">
                                    </div>
                                  </div>
