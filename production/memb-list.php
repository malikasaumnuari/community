                  ...
                  <div class="x_content">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="memb-acc.php?id_community=<?php echo $id_community?>">Member Requests</a>
                          </li>
                          <li><a href="memb-list.php?id_community=<?php echo $id_community?>">Manage Members</a>
                          </li>
                        </ul>
                      </li>
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        if($row['id_user']==$id_user){
                          ...
                          echo "
                          <td><a href='members/php_action/remove.php?id_member=".$row['id_member']."&amp;id_community=$id_community'><button type='button' class='btn btn-danger'>x Kick</button></a></td>
                          ";
                        }
                        echo "
                        </tr>";
