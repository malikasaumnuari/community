                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
            $sql = "SELECT * FROM posts p, users u WHERE p.active = 1 AND p.id_user=u.id_user AND p.id_thread={$id_thread}";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>
                        <a href='comments/php_action/remove.php?id_community=$id_community&amp;id_thread=".$row['id_thread']."&amp;id_post=".$row['id_post']."'> <button type='button' class='btn btn-danger'>Remove</button></a>
                        </td>
                        </tr>";
                }
            } else {
