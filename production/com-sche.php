...
<!--start here-->
          ...
          <div class="">
            ...
            <h3 align='center'><?php echo $data['name_community']?></h3>
              ...
              <ul class='list-unstyled'>
                ...
                <li>
                  <a type="button" class="btn btn-default active col-md-12 col-sm-12 col-xs-12" >View Schedules</a>
                </li>
                <li>
                  ...
                  <div class="x_content">
                    ...
                    $sql3 = mysqli_query($con, "SELECT * FROM communities WHERE active=2 AND id_master = {$id_user} AND id_community={$id_community}");
                      if($sql3->num_rows > 0){ echo '<ul class="nav navbar-right panel_toolbox">
                          <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-edit"></i>Edit Schedule</a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="sche-add.php?id_community='.$id_community.'">Add Schedule</a>
                          </li>
                          <li><a href="sche-list.php?id_community='.$id_community.'">List Schedule</a>
                          </li>
                        </ul>
                      </li>
                    ...
                    <br>
                      <?php
            $sql = "SELECT * FROM agendas WHERE active = 3 AND id_community={$id_community}";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                   ...
                   <h1><i class='fa fa-calendar' style='font-size: 150px'> </i></h1>
                    </div>
                    <div class='col-md-8 col-sm-6 col-xs-6'>
                    <h2>".$row['name_agenda']."</h2>
                    <ul class='list-unstyled'>
                      <li>
                      ...
                      <li>
                        <div class='col-md-12 col-sm-12 col-xs-12'>
                          <div class='col-md-3 col-sm-6 col-xs-12'> Time:</div>
                          <div class='col-md-9 col-sm-6 col-xs-12'>
                      ...
                      <li>
                          <div class='col-md-12 col-sm-12 col-xs-12'>
                          <div class='col-md-3 col-sm-6 col-xs-12'> Location:</div>
                          <div class='col-md-9 col-sm-6 col-xs-12'>
                          ".$row['agenda_location']."
                        </div>
                      </div>
                      ...
                      <li>
                          <div class='col-md-12 col-sm-12 col-xs-12'>
                          <div class='col-md-3 col-sm-6 col-xs-12'> Message:</div>
                          <div class='col-md-9 col-sm-6 col-xs-12'>
                          ".$row['content_agenda']."
                        </div>
                      </div>
                  ...
                  <div class='col-md-12 col-sm-6 col-xs-12' align='center'>
                        <a href='sche-notes.php?id_community=".$id_community."&amp;id_agenda=".$row['id_agenda']."' type=button class='btn btn-success'>End Schedule</a>
                  </div>
                  <div class='clearfix'></div>
                  <br>
                  ";
                ...
                echo "<br>
                    ...
                    <h1><i class='fa fa-frown-o' style='font-size: 150px'> </i></h1>
                    </div>
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                    <h2 align='center'>There are no active schedule.</h2>
                    <br>";
            }
            ?>
        ...
        <tbody>
            ...
            <?php
            $sql = "SELECT * FROM agendas WHERE active = 1 AND id_community={$id_community}";
            $result = $connect->query($sql);
            ...
            if($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='6'><center>There are no future schedules.</center></td></tr>";
            }
            ?>
        </tbody>
                         </table>
    ...
    <script src="../vendors/pdfmake/build/vfs_fonts.js"></script>    <!-- Custom Theme Scripts -->
