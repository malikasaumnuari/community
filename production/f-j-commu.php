...
$con=mysqli_connect("127.0.0.1","root","","bogor_community");
                      ...
                      $sql4 = mysqli_query($con, "SELECT * FROM members_community WHERE (active=2 OR active=1) AND id_master = {$id_user} AND id_community={$id_community}");
                      if($sql4->num_rows < 1  ) {
                        header('location: index.php');
                      }
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
                  ...
                  <div class='x_content'>
                    <br />
                    <form action='communities/php_action/join.php?id_community=<?php echo $id_community?>' method='post' id='demo-form2' data-parsley-validate class='form-horizontal form-label-left'>
                            



                  <div class='form-group'>
                    <label class='control-label col-md-3 col-sm-3 col-xs-12'>Alasan bergabung<span class='required'>*</span></label>
                    <div class='col-md-6 col-sm-6 col-xs-12'>
                      <input type='textarea' name='join_reason' class='resizable_textarea form-control col-md-7 col-xs-12' required='required' col-md-7 col-xs-12></textarea>
                    </div>
                  </div>
                      ...
                      <div class='form-group'>
                        <div class='col-md-6 col-sm-6 col-xs-12 col-md-offset-3'>
                          <a href='com-front.php?id_community=".$row['id_community']."' class='btn btn-danger' type='button'>Cancel</a>
